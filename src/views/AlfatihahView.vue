<template>
  ...
  <div class="surah">
    <h1>Al-Fatihah<span>(Pembukaan)</span></h1>
     <label>
...
name:'AlfatihahView',
  ...
  async mounted(){
    ...
    let resultVerses = await axios.get('https://api.quran.com/api/v4/quran/verses/uthmani?chapter_number=1');
    this.verses = resultVerses.data.verses

    let resultArti = await axios.get('https://api.quran.com/api/v4/quran/translations/134?chapter_number=1')
